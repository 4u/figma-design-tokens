 ...
 */
export function errorBox(nodes, errors, breadcrumbs) {
    const withHighlight = [];
    const errorMessages = [];
    ...
    errorMessages.push(`${chalk.red.bold("error: ")}found ${chalk.yellow(withHighlight.length)} error${withHighlight.length > 1 ? "s" : ""}`);
    errorMessages.push("");
    withHighlight
